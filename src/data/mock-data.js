...
export const locationsTab = [
  ...
  { id: 4, label: 'Event Staff', icon: <GiOrganigram size={24}/>},
  { id: 5, label: 'Event Housing', icon: <BiHomeAlt size={24} /> },
  { id: 6, label: 'Pets', icon: <GiDogBowl size={24} /> },
  { id: 7, label: 'Babysitting', icon: <GiKidSlide size={24} /> },
  { id: 8, label: 'Bed & Breakfast ', icon: <AiOutlineCoffee size={24} /> },
  { id: 9, label: 'Athletics', icon: <GiWeight size={24} /> },
  { id: 10, label: 'Performances', icon: <GiXylophone size={24} /> },
  { id: 11, label: 'Parties', icon: <GiGolfFlag size={24} /> },
  { id: 12, label: 'Guided Tours', icon: <GiSpaceNeedle size={24} /> },
  { id: 13, label: 'Vacation Packages', icon: <FaUmbrellaBeach size={24} /> },
  { id: 14, label: 'Vehicle Rental', icon: <GiFullMotorcycleHelmet size={24} /> },
  { id: 15, label: 'Construction', icon: <GiMineTruck size={24}/>},
];
